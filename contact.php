			...
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<div class="about_content">
						...
						<p class="about_text">Travelix services are up to date with all of the Prices really reasonable. Tour to places that are very safe and secure in all terms. A comprehensive website with many awards as a leading Operator in world. Tour Packages in the world cover the Summer tour package, Winter tour package, Day Trips, Weekend trips, and much more.We will help you in making your passion real with the least budget by offering this many reosonable Trips all over world.</p>
